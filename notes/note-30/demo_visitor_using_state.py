...
class Dynamic_Mean:
    ...
    def __init__(self):
        ...
        ##
        ## ================================================================
        ## Good-Simple-Rule_of-thumb -- identify all the attributes in __init__
        ## ================================================================
        ##
        ## I had marked these attributes as 'private' with a leading underbar,
        ## but I was also expecting the user to reach in and read these values,
        ## so that makes them public.  Too bad I can't make 'em readonly.

        ## now that we have a reset method, use it -- have ONE VERSION OF THE TRUTH
        self.reset()
